...
* Фиды: базовые и фильтрующие, публичные и приватные (см. `feed_types.md`);
* Френдленты (агрегаторы);
* Таблица прав на запись в фид;
* Таблица прав на чтение приватных фидов;
* Локальные бампы;
* Посты в фидах;
* Комментарии, лайки, аттачи;
* Поле в таблице `users` для хайдов отдельных фидов;
* Сервисные триггеры (см. `triggers.md`).
